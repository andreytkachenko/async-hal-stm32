...
pub static INTERRUPTS: [Option<unsafe extern "C" fn()>; 90] = [
    ...
    /* EXTI0 */         Some(hal::gpio::exti0_handler),
    /* EXTI1 */         Some(hal::gpio::exti1_handler),
    /* EXTI2 */         Some(hal::gpio::exti2_handler),
    /* EXTI3 */         Some(hal::gpio::exti3_handler),
    /* EXTI4 */         Some(hal::gpio::exti4_handler),
    ...
    /* EXTI9_5 */       Some(hal::gpio::exti9_5_handler),
    ...
    /* EXTI15_10 */     Some(hal::gpio::exti15_10_handler),
